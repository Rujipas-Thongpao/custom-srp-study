...
// Reflection map, which is a cube map texture
...
float3 SampleEnvironment ( Surface surfaceWS){
    float3 uvw = 0.0; // similar to the uv but in the 3 dimension
    uvw = reflect(-surfaceWS.viewDirection, surfaceWS.normal);
